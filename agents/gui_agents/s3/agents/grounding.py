...
class OSWorldACI(ACI):
    def __init__(
        ...
        # Store step tracking for code agent
        self.current_step = 0
    ...
    def set_step_info(self, current_step: int, max_steps: int):
        """Set the current step count and max steps for code agent budget tracking."""
    ...
    def call_code_agent(self, task: str = None):
        ...
        **🚨 CRITICAL GUIDELINES:**
        ...
        if task_to_execute:
            ...
            logger.info(f"Current step: {self.current_step}, Max steps: {self.max_steps}")
